  ...
  return (
    ...
    >
      ...
      <div className="mt-8 flex gap-3 min-[500px]:absolute min-[500px]:right-15 min-[500px]:bottom-12">
        <i class="devicon-facebook-plain text-white p-3 border-[1px] rounded-[50%] hover:text-[violet]"></i>
        <i class="devicon-twitter-original text-white p-3 border-[1px] rounded-[50%] hover:text-[violet]"></i>
        <i class="fa-brands fa-instagram text-white p-3 border-[1px] rounded-[50%] hover:text-[violet]"></i>
      </div>
    </main>
  );
}
